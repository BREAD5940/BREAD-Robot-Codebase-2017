...
public class RollerUpdateProcedureModule extends AbstractProcedureModule {
	...
	public RollerUpdateProcedureModule(String rollerName, LoggerModule logger, MotorSetModule roller, AxisModule axis)
			throws IllegalArgumentException {
		super(rollerName + "_update_procedure", new ModuleHashtable<>(roller), logger);
		this.logger.checkInitializationArgs(this, RollerUpdateProcedureModule.class, new Object[]{roller, axis});
		this.roller = roller;
		this.axis = axis;
		this.logger.logInitialization(this, RollerUpdateProcedureModule.class, new Object[]{roller, axis});
	}
